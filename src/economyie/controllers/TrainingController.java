...
public class TrainingController implements Initializable {
    ...
    private String gazetteerHome = MainApplication.gateHome + "\\plugins\\ANNIE\\resources\\gazetteer";
    private String enterpriseName = "enterprise_name.lst";
    private String enterpriseOwner = "enterprise_owner.lst";
    private String enterpriseAddress = "enterprise_address.lst";
    private String enterpriseProduct = "enterprise_product.lst";
